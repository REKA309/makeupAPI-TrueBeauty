...
{
    let{ api_featured_image="",brand="",description="",
    ...
    const productpa=document.createElement("h4");
    productpa.setAttribute("class","card-text");
    productpa.append(name);
    cardBody.append(productpa)
    const productype=document.createElement("h4");
    productype.setAttribute("class","card-text");
    productype.append(product_type);
    cardBody.append(productype);
   const pricep=document.createElement("h6");
    pricep.setAttribute("class","card-text");
    if(price_sign==null){price_sign="$"}
    if(price=="0.0"){price="13.7"}
    pricep.append(price_sign,price);
